...
public class Asean {
    // 출석점수(check), 중간고사midTerm, 기말고사finalTerm
	// 변수를 설정해주세요.
	...
	// 공굥 발표점수인 presentationScore를 static으로 만들어주세요.
	// 이 점수는 19점 입니다.
	public static int presentationScore = 19;
	
	// 생성자는 객체 생성시 출석, 중간소가, 기말고사 점수만
	// 받아서 수치를 입력해줍니다.
	...
	// mian지역에서 다이렉트로 조회가 불가능합니다.
	// Aesan을 new 키워드로 만들지 않고도
