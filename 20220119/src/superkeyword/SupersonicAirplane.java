...
public class SupersonicAirplane extends Airplane {
	...
	// 초음속 비행은 속도가 900이상, 1300이하인 경우 호출 됩니다.
	// 현재는 SupersonicAirplane 내부이기 때문에
	// public void fly() 작성시 오버라이딩이 일어나게 되는데
	// 그럼에도 불구하고 일반 비행을 하게 되는 구간인 경우 super.fly()를 호출하면
	// 부모쪽의 fly가 호출됩니다.
	public void fly() {
		// 기본속도 + 500의 결과 속도가 900 이하로 판전된 경우
		if(speed + 500 <= 900) {
			super.fly();
		}else {
			...
			System.out.println("초음속 비행중입니다: " + speed + "km/h 로 비행 중 입니다.");
		}
	}
}
