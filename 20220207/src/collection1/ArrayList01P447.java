...
public class ArrayList01P447 {
	...
	public static void main(String[] args) {
		// List는 인터페이스이고 구현 클래스로 ArrayList와 LinkedList를 받을 수 있고
		// 기본적으로는 ArrayList를 쓰게 됩니다.
		// java.util의 List나 ArrayList를 import에 쓰면 됩니다.
		
		// List느느 생성시 List<자료형>을 적어 넣어 해당 자료형을 
		// 가변 길이 배열 형태로 받아줄 수 있습니다.
		// <> 사이에는 기본형 자료(int, double, boolean등)은 올 수 없습니다.
